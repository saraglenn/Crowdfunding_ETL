 ...
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "990      Devolved foreground customer loyalty    7800.0    6839.0      failed   \n",
       "991            Reduced reciprocal focus group    9800.0   11091.0  successful   \n",
       "992                Networked global migration    3100.0   13223.0  successful   \n",
       "993      De-engineered even-keeled definition    9800.0    7608.0    canceled   \n",
       "994    Implemented bi-directional flexibility  141100.0   74073.0      failed   \n",
       ...
       "990             64      US      USD    2021-06-09  2021-06-18       False   \n",
       "991            241      US      USD    2020-12-09  2021-05-26       False   \n",
       "992            132      US      USD    2020-06-14  2021-02-09       False   \n",
       "993             75      IT      EUR    2021-07-03  2021-07-08       False   \n",
       "994            842      US      USD    2021-11-15  2021-12-07       False   \n",
       "995           2043      US      USD    2020-12-29  2021-05-30       False   \n",
       "996            112      US      USD    2021-10-15  2021-11-30       False   \n",
       "997            139      IT      EUR    2021-11-06  2021-12-10       False   \n",
       "998            374      US      USD    2020-10-08  2021-04-11       False   \n",
       "999           1122      US      USD    2020-12-30  2021-08-18       False   \n",
       "\n",
       "     spotlight        category & sub-category      category  \\\n",
       "990       True             film & video/drama  film & video   \n",
       "991       True                     music/rock         music   \n",
       "992       True             film & video/drama  film & video   \n",
       "993       True  photography/photography books   photography   \n",
       "994       True        publishing/translations    publishing   \n",
       "995       True               food/food trucks          food   \n",
       "996      False                  theater/plays       theater   \n",
       "997      False                  theater/plays       theater   \n",
       "998       True               music/indie rock         music   \n",
       "999      False               food/food trucks          food   \n",
       "\n",
       "           subcategory category_id subcategory_id  \n",
       "990              drama       cat05         scat07  \n",
       "991               rock       cat02         scat02  \n",
       "992              drama       cat05         scat07  \n",
       "993  photography books       cat08        scat015  \n",
       "994       translations       cat06        scat019  \n",
       "995        food trucks       cat01         scat01  \n",
       "996              plays       cat04         scat04  \n",
       "997              plays       cat04         scat04  \n",
       "998         indie rock       cat02         scat08  \n",
       "999        food trucks       cat01         scat01  "
      ]
     },
     "execution_count": 27,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "4      failed             53      US      USD    2020-12-21  2021-08-23   \n",
       "\n",
       "  category_id subcategory_id contact_id  \n",
       "0       cat01         scat01       4661  \n",
       "1       cat02         scat02       3765  \n",
       "2       cat03         scat03       4187  \n",
       "3       cat02         scat02       4941  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "desired_order = [\"cf_id\", \"contact_id\", \"company_name\", \"description\", \"goal\", \"pledged\", \"outcome\", \"backers_count\", \"country\", \"currency\", \"launched_date\", \"end_date\", \"category_id\", \"subcategory_id\"]\n",
    "# Reorder the columns\n",
    "campaign_cleaned = campaign_cleaned.reindex(columns=desired_order)\n",
    "# Print the resulting DataFrame\n",
    "print(campaign_cleaned)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Reorder the columns\n",
    "contacts_df_clean = contacts_df_clean.reindex(columns=desired_order)\n",
    "\n",
    "# Print the resulting DataFrame\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "contacts_string_df = pd.read_csv(\"C:/Users/scath/Crowdfunding_ETL/contacts_string_data.csv\")\n",
  ...
  },
  {
   ...
   "source": [
    "# Define and assign a DataFrame\n",
    "contact_string_df = pd.DataFrame({'contact_info': ['Contact 1234', 'Contact 5678']})\n",
    "\n",
    "# Extract the four-digit contact ID and assign it to 'contact_id' column\n",
    "contact_string_df['contact_id'] = contact_string_df['contact_info'].str.extract(r'(\\d{4})')\n",
    "\n",
    "# Print the updated DataFrame\n",
    "print(contact_string_df)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      "       contact_info  name\n",
      "0    Name: John Doe  John\n",
      "1  Name: Jane Smith  Jane\n"
     ]
    }
   ],
   "source": [
    "# Assuming you have a DataFrame named 'contact_df' with a 'contact_info' column\n",
    "contact_df = pd.DataFrame({'contact_info': ['Name: John Doe', 'Name: Jane Smith']})\n",
    "\n",
    "# Extract the name and add it to a new column 'name'\n",
    "contact_df['name'] = contact_df['contact_info'].str.extract(r'(Name: (\\w+))')[1]\n",
    "\n",
    "# Print the updated DataFrame\n",
    "print(contact_df)"
   ]
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "0    Name: John Doe  John   NaN\n",
      "1  Name: Jane Smith  Jane   NaN\n"
     ]
    }
   ],
   "source": [
    "# Extract the email address and add it to a new column 'email'\n",
    "contact_df['email'] = contact_df['contact_info'].str.extract(r'(\\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}\\b)')\n",
    "\n",
    "# Print the updated DataFrame\n",
    "print(contact_df)"
   ]
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Unique count in category_id column: 9\n",
      "Unique count in subcategory_id column: 24\n"
     ]
    }
   ],
   "source": [
    "# Check the number of unique values in the \"category_id\" column\n",
    "category_unique_count = category_df['category_id'].nunique()\n",
    "print(\"Unique count in category_id column:\", category_unique_count)\n",
    "\n",
    "# Check the number of unique values in the \"subcategory_id\" column\n",
    "subcategory_unique_count = subcategory_df['subcategory_id'].nunique()\n",
    "print(\"Unique count in subcategory_id column:\", subcategory_unique_count)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "campaign_cleaned_df = pd.read_csv('campaign_cleaned.csv')"
   ]
  },
  {
   "cell_type": "code",
